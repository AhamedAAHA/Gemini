...
export const REFERENCE_PRICES: Record<string, ReferenceEntry> = {
  ...
  "80053": { code: "80053", description: "Comprehensive metabolic panel (CMP)", allowable: 22, category: "lab" },
  "85025": { code: "85025", description: "Complete blood count (CBC), automated", allowable: 14, category: "lab" },
  "81002": { code: "81002", description: "Urinalysis, automated without microscopy", allowable: 7, category: "lab" },
  "88305": { code: "88305", description: "Surgical pathology, gross and microscopic", allowable: 128, category: "lab" },
  "36415": { code: "36415", description: "Routine venipuncture (blood draw)", allowable: 4, category: "lab" },
  "62323": { code: "62323", description: "Epidural steroid injection, lumbar", allowable: 235, category: "professional" },
  "64483": { code: "64483", description: "Transforaminal epidural steroid injection, lumbar", allowable: 260, category: "professional" },
  "90471": { code: "90471", description: "Immunization administration, one vaccine", allowable: 22, category: "professional" },
  "G0008": { code: "G0008", description: "Influenza vaccine administration", allowable: 8, category: "professional" },
  "47562": { code: "47562", description: "Laparoscopic cholecystectomy", allowable: 1120, category: "facility" },
  "29881": { code: "29881", description: "Arthroscopy, knee, meniscectomy", allowable: 1350, category: "facility" },
